with cycles as (
    select (block_height - 60549)/2100  as cycle, min(block_height) as first_block,  min(block_height)+2099 as last_block
...
select sender_address as address, sum(amount::bigint)/1000000 as amount
from tokens t 
