...
, max(fx.amount / fy.amount * tky.factor / tkx.factor * ps.price) as price_max
, min(fx.amount / fy.amount * tky.factor / tkx.factor * ps.price) as price_min
, avg(fx.amount / fy.amount * tky.factor / tkx.factor * ps.price) as price_avg
, min(fx.amount / fy.amount * tky.factor / tkx.factor * 1) as wldn_idx
