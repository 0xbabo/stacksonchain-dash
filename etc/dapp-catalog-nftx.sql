...
with cat_sc (link, name, contract_like, source_match) as (VALUES
    ...
    ('https://gamma.io/','Gamma', 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace-%', ''),
    ('https://www.tradeport.xyz/','Byzantion', 'SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.%market%', ''),
    ('https://www.tradeport.xyz/','Byzantion', 'SP1BX0P4MZ5A3A5JCH0E10YNS170QFR2VQ6TT4NRH.%market%', ''),
    ('https://www.stacksart.com/','StacksArt', 'SPJW1XE278YMCEYMXB8ZFGJMH8ZVAAEDP2S2PJYG.%market%', ''),
    ('https://thisisnumberone.com/','This is #1', 'SP3N4AJFZZYC4BK99H53XP8KDGXFGQ2PRSQP2HGT6.%', ''),
