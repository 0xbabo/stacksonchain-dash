with cat_cust (link,name,contract_like_arr,source_match) as (
VALUES ('https://price.btc.us/','price.btc',ARRAY['SP3XYJ8XFZYF7MD86QQ5EF8HBVHHZFFQ9HM6SPJNQ.%'],'')
...
ARRAY['SP1CSHTKVHMMQJ7PRQRFYW6SB4QAW6SR3XY2F81PA.stxnft-auctions%'
    , 'SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace%'
],'')
, ('https://www.tradeport.xyz/','Tradeport',
ARRAY['SP2KAF9RF86PVX3NEE27DFV1CQX0T4WGR41X3S45C.%wrapper%'
...
, cat_nonc (link, name, contract_like, comm_like_arr) as (
VALUES ('https://gamma.io/','Gamma','',ARRAY['%gamma%','%stxnft%'])
, ('https://www.tradeport.xyz/','Tradeport','',
ARRAY['%byz%','%tradeport%'
